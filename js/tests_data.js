// ETS 2026 Part 5 Tests Data - Auto Generated
const toeicTestsData = [
  {
    "id": 1,
    "title": "BÀI ÔN TẬP 01",
    "questions": [
      {
        "question": "Mr. Tanaka asked the team to submit ______ weekly progress reports by Friday afternoon.",
        "options": {
          "A": "them",
          "B": "their",
          "C": "themselves",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. their</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng trước cụm danh từ <code>weekly progress reports</code> (các báo cáo tiến độ hàng tuần) → cần một tính từ sở hữu.<br>- Chủ ngữ là <code>the team</code> (danh từ tập hợp chỉ nhóm người), nộp báo cáo của họ → chọn tính từ sở hữu <strong class=\"hl-vocab\">their</strong>.<br><br><strong>Dịch câu:</strong><br><em>Ông Tanaka đã yêu cầu cả nhóm nộp các báo cáo tiến độ hàng tuần của họ trước chiều thứ Sáu.</em>"
      },
      {
        "question": "The marketing department has developed a new strategy to promote ______ products online.",
        "options": {
          "A": "we",
          "B": "our",
          "C": "ours",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. our</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng trước danh từ <code>products</code> → cần điền một tính từ sở hữu để bổ nghĩa.<br>- Chọn tính từ sở hữu <strong class=\"hl-vocab\">our</strong> (của chúng tôi).<br><br><strong>Dịch câu:</strong><br><em>Bộ phận tiếp thị đã phát triển một chiến lược mới để quảng bá sản phẩm của chúng tôi trực tuyến.</em>"
      },
      {
        "question": "The newly hired assistant is responsible for ______ the office database.",
        "options": {
          "A": "maintain",
          "B": "maintaining",
          "C": "maintenance",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. maintaining</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Sau giới từ <code>for</code> (ở đây thuộc cấu trúc <code>be responsible for</code>) cần điền một danh động từ (V-ing) hoặc danh từ.<br>- Vì phía sau chỗ trống có tân ngữ <code>the office database</code> → chọn danh động từ <strong class=\"hl-vocab\">maintaining</strong>.<br><br><strong>Dịch câu:</strong><br><em>Trợ lý mới tuyển dụng chịu trách nhiệm duy trì cơ sở dữ liệu của văn phòng.</em>"
      },
      {
        "question": "Employees must wear safety equipment ______ entering the manufacturing area.",
        "options": {
          "A": "before",
          "B": "during",
          "C": "inside",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. before</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng trước động từ dạng V-ing <code>entering...</code> đóng vai trò như mệnh đề phân từ rút gọn hoặc sau giới từ chỉ thời gian.<br>- Dựa vào ý nghĩa an toàn lao động: phải mặc đồ bảo hộ <strong>trước khi</strong> bước vào khu sản xuất → chọn giới từ/liên từ <strong class=\"hl-vocab\">before</strong>.<br><br><strong>Dịch câu:</strong><br><em>Nhân viên phải mặc thiết bị an toàn trước khi vào khu vực sản xuất.</em>"
      },
      {
        "question": "The board members agreed that the proposed merger was ______ beneficial to both companies.",
        "options": {
          "A": "mutual",
          "B": "mutually",
          "C": "mutuality",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. mutually</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng trước tính từ <code>beneficial</code> (có lợi) → cần điền một trạng từ để bổ nghĩa cho tính từ đó.<br>- Chọn trạng từ <strong class=\"hl-vocab\">mutually</strong> (lẫn nhau, đôi bên).<br><br><strong>Dịch câu:</strong><br><em>Các thành viên ban quản trị đã đồng ý rằng vụ sáp nhập được đề xuất có lợi cho cả hai công ty.</em>"
      },
      {
        "question": "Ms. Patel will oversee the negotiation of the contract ______ Mr. Davis is on leave.",
        "options": {
          "A": "while",
          "B": "during",
          "C": "because of",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. while</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Sau chỗ trống là một mệnh đề hoàn chỉnh (S + V: <code>Mr. Davis is on leave</code>) → cần điền một liên từ.<br>- Loại B, C vì là giới từ (không đi kèm trực tiếp với mệnh đề). Loại D vì không hợp nghĩa.<br>- Chọn liên từ chỉ thời gian song hành <strong class=\"hl-vocab\">while</strong> (trong khi).<br><br><strong>Dịch câu:</strong><br><em>Cô Patel sẽ giám sát việc đàm phán hợp đồng trong khi ông Davis đang nghỉ phép.</em>"
      },
      {
        "question": "Due to a technical malfunction, the delivery of the shipments was ______ delayed.",
        "options": {
          "A": "temporary",
          "B": "temporarily",
          "C": "temporariness",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. temporarily</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng giữa trợ động từ dạng bị động <code>was</code> và quá khứ phân từ V3/ed <code>delayed</code> → cần điền một trạng từ bổ nghĩa cho động từ bị động.<br>- Chọn trạng từ <strong class=\"hl-vocab\">temporarily</strong> (tạm thời).<br><br><strong>Dịch câu:</strong><br><em>Do sự cố kỹ thuật, việc giao các lô hàng đã bị trì hoãn tạm thời.</em>"
      },
      {
        "question": "All visitors must obtain a visitor pass at the reception desk ______ entering the facility.",
        "options": {
          "A": "prior to",
          "B": "except",
          "C": "ahead",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. prior to</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cần một giới từ đi kèm với dạng V-ing <code>entering</code> phía sau.<br>- Cấu trúc: <code>prior to + V-ing / Noun</code> = <code>before</code> (trước khi).<br>- Do đó chọn cụm giới từ <strong class=\"hl-vocab\">prior to</strong>.<br><br><strong>Dịch câu:</strong><br><em>Tall cả khách tham quan phải nhận thẻ khách tại quầy lễ tân trước khi vào cơ sở.</em>"
      },
      {
        "question": "The budget committee will carefully ______ all financial proposals before making a final decision.",
        "options": {
          "A": "review",
          "B": "reviews",
          "C": "reviewed",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. review</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau động từ khuyết thiếu <code>will</code> và trạng từ bổ nghĩa <code>carefully</code> → cần điền động từ nguyên mẫu (V-bare).<br>- Chọn động từ nguyên mẫu <strong class=\"hl-vocab\">review</strong> (xem xét, đánh giá).<br><br><strong>Dịch câu:</strong><br><em>Ủy ban ngân sách sẽ xem xét cẩn thận tất cả các đề xuất tài chính trước khi đưa ra quyết định cuối cùng.</em>"
      },
      {
        "question": "Customers who purchase three or more items are ______ for a ten percent discount.",
        "options": {
          "A": "eligible",
          "B": "eligibility",
          "C": "eligibly",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. eligible</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng sau động từ liên kết <code>are</code> và trước giới từ <code>for</code> → cần điền một tính từ.<br>- Cấu trúc quen thuộc: <code>be eligible for something / to do something</code> (đủ điều kiện, đủ tư cách nhận cái gì).<br>- Chọn tính từ <strong class=\"hl-vocab\">eligible</strong>.<br><br><strong>Dịch câu:</strong><br><em>Khách hàng mua từ ba sản phẩm trở lên sẽ đủ điều kiện được giảm giá mười phần trăm.</em>"
      },
      {
        "question": "The manager gave a brief ______ of the new project guidelines during the meeting.",
        "options": {
          "A": "explain",
          "B": "explanation",
          "C": "explanatory",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. explanation</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau mạo từ <code>a</code> và tính từ <code>brief</code> (ngắn gọn) → cần điền một danh từ để tạo thành cụm danh từ.<br>- Chọn danh từ <strong class=\"hl-vocab\">explanation</strong> (sự giải thích).<br><br><strong>Dịch câu:</strong><br><em>Người quản lý đã đưa ra lời giải thích ngắn gọn về các hướng dẫn dự án mới trong suốt cuộc họp.</em>"
      },
      {
        "question": "The construction of the new headquarters is expected to be completed ______ schedule.",
        "options": {
          "A": "ahead of",
          "B": "in",
          "C": "at",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. ahead of</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đi kèm với danh từ <code>schedule</code> (lịch trình) phía sau để chỉ tiến độ vượt kế hoạch.<br>- Cụm giới từ cố định: <code>ahead of schedule</code> (trước tiến độ/trước lịch trình).<br>- Loại C (at) vì không đi cùng schedule để chỉ thời gian hoàn thành (chỉ có \"on schedule\" hoặc \"ahead of schedule\").<br>- Do đó chọn cụm giới từ <strong class=\"hl-vocab\">ahead of</strong>.<br><br><strong>Dịch câu:</strong><br><em>Việc xây dựng trụ sở mới dự kiến sẽ hoàn thành trước tiến độ.</em>"
      },
      {
        "question": "If you experience any technical difficulties, please contact our support team ______ assistance.",
        "options": {
          "A": "for",
          "B": "to",
          "C": "with",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. for</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đi kèm sau cụm động từ <code>contact someone</code> để chỉ mục đích yêu cầu sự giúp đỡ.<br>- Cấu trúc: <code>contact someone for something</code> (liên hệ ai đó để được/yêu cầu cái gì).<br>- Chọn giới từ <strong class=\"hl-vocab\">for</strong>.<br><br><strong>Dịch câu:</strong><br><em>Nếu bạn gặp bất kỳ khó khăn kỹ thuật nào, vui lòng liên hệ với đội ngũ hỗ trợ của chúng tôi để được giúp đỡ.</em>"
      },
      {
        "question": "The restaurant is closed for renovations but is expected to ______ early next month.",
        "options": {
          "A": "reopen",
          "B": "reopening",
          "C": "reopened",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. reopen</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau từ chỉ mục đích <code>to</code> (nằm trong cấu trúc <code>be expected to</code>) → cần điền một động từ nguyên mẫu (V-bare).<br>- Chọn động từ nguyên mẫu <strong class=\"hl-vocab\">reopen</strong> (mở cửa trở lại).<br><br><strong>Dịch câu:</strong><br><em>Nhà hàng đóng cửa để cải tạo nhưng dự kiến sẽ mở cửa trở lại vào đầu tháng tới.</em>"
      },
      {
        "question": "Ms. Cho has been appointed as the new director because of her ______ experience in HR.",
        "options": {
          "A": "extend",
          "B": "extensive",
          "C": "extensively",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. extensive</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng trước danh từ <code>experience</code> (kinh nghiệm) và sau tính từ sở hữu <code>her</code> → cần điền một tính từ bổ nghĩa cho danh từ.<br>- Chọn tính từ <strong class=\"hl-vocab\">extensive</strong> (sâu rộng, phong phú).<br><br><strong>Dịch câu:</strong><br><em>Cô Cho đã được bổ nhiệm làm giám đốc mới nhờ kinh nghiệm sâu rộng trong lĩnh vực nhân sự.</em>"
      },
      {
        "question": "The company decided to terminate the lease contract ______ the landlord failed to repair the roof.",
        "options": {
          "A": "because",
          "B": "due to",
          "C": "despite",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. because</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Sau chỗ trống là một mệnh đề hoàn chỉnh (S + V: <code>the landlord failed to...</code>) → cần một liên từ.<br>- Loại B vì là giới từ. Loại C, D không hợp nghĩa.<br>- Chọn liên từ chỉ nguyên nhân <strong class=\"hl-vocab\">because</strong> (bởi vì).<br><br><strong>Dịch câu:</strong><br><em>Công ty quyết định chấm dứt hợp đồng thuê vì chủ nhà đã không sửa chữa mái nhà.</em>"
      },
      {
        "question": "We apologize for any inconvenience caused by the ______ of the regional conference.",
        "options": {
          "A": "cancel",
          "B": "cancellation",
          "C": "canceling",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. cancellation</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau mạo từ <code>the</code> và trước giới từ <code>of</code> → cần điền một danh từ.<br>- Chọn danh từ <strong class=\"hl-vocab\">cancellation</strong> (sự hủy bỏ).<br><br><strong>Dịch câu:</strong><br><em>Chúng tôi xin lỗi vì bất kỳ sự bất tiện nào gây ra bởi việc hủy bỏ hội nghị khu vực.</em>"
      },
      {
        "question": "The HR director is committed to hiring candidates ______ demonstrate excellent communication skills.",
        "options": {
          "A": "who",
          "B": "which",
          "C": "whose",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. who</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng ngay sau danh từ chỉ người <code>candidates</code> (ứng viên) và đứng trước động từ chính <code>demonstrate</code> → cần một đại từ quan hệ đóng vai trò làm chủ ngữ chỉ người.<br>- Chọn đại từ quan hệ <strong class=\"hl-vocab\">who</strong>.<br><br><strong>Dịch câu:</strong><br><em>Giám đốc nhân sự cam kết tuyển dụng những ứng viên thể hiện kỹ năng giao tiếp xuất sắc.</em>"
      },
      {
        "question": "The presentation by Mr. Gomez was very ______ and well received by the audience.",
        "options": {
          "A": "inform",
          "B": "informative",
          "C": "information",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. informative</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau trạng từ chỉ mức độ <code>very</code> và động từ liên kết <code>was</code> → cần điền một tính từ đóng vai trò tính từ vị ngữ.<br>- Chọn tính từ <strong class=\"hl-vocab\">informative</strong> (nhiều thông tin hữu ích).<br><br><strong>Dịch câu:</strong><br><em>Bài thuyết trình của ông Gomez rất nhiều thông tin bổ ích và được khán giả đón nhận nồng nhiệt.</em>"
      },
      {
        "question": "Staff members are encouraged to submit their travel expense reports ______ to ensure quick reimbursement.",
        "options": {
          "A": "prompt",
          "B": "promptly",
          "C": "promptness",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. promptly</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau một mệnh đề hoàn chỉnh (S + V + O: <code>submit their travel expense reports</code>) → cần điền một trạng từ để bổ nghĩa cho hành động nộp báo cáo.<br>- Chọn trạng từ <strong class=\"hl-vocab\">promptly</strong> (nhanh chóng, ngay lập tức).<br><br><strong>Dịch câu:</strong><br><em>Nhân viên được khuyến khích nộp báo cáo chi phí công tác nhanh chóng để đảm bảo việc hoàn tiền diễn ra mau lẹ.</em>"
      },
      {
        "question": "The new software is fully ______ with all major operating systems.",
        "options": {
          "A": "compatible",
          "B": "compatibility",
          "C": "compatibly",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. compatible</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau động từ liên kết <code>is</code> và trạng từ <code>fully</code> → cần điền một tính từ.<br>- Cấu trúc: <code>be compatible with something</code> (tương thích với cái gì).<br>- Chọn tính từ <strong class=\"hl-vocab\">compatible</strong>.<br><br><strong>Dịch câu:</strong><br><em>Phần mềm mới hoàn toàn tương thích với tất cả các hệ điều hành lớn.</em>"
      },
      {
        "question": "The customer service representative handled the complaint with great ______ and patience.",
        "options": {
          "A": "professional",
          "B": "professionalism",
          "C": "professionally",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. professionalism</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau giới từ <code>with</code> và tính từ <code>great</code> → cần điền một danh từ để tạo thành trạng từ chỉ cách thức.<br>- Chọn danh từ chỉ phẩm chất <strong class=\"hl-vocab\">professionalism</strong> (sự chuyên nghiệp).<br><br><strong>Dịch câu:</strong><br><em>Đại diện dịch vụ khách hàng đã giải quyết khiếu nại với sự chuyên nghiệp và kiên nhẫn tuyệt vời.</em>"
      },
      {
        "question": "The contract states that the payment must be made within thirty days of the ______ date.",
        "options": {
          "A": "invoice",
          "B": "invoices",
          "C": "invoiced",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. invoice</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>date</code> để bổ nghĩa và tạo thành cụm danh từ kép thông dụng trong thương mại: <code>invoice date</code> (ngày ghi trên hóa đơn).<br>- Chọn danh từ <strong class=\"hl-vocab\">invoice</strong>.<br><br><strong>Dịch câu:</strong><br><em>Hợp đồng quy định rằng thanh toán phải được thực hiện trong vòng ba mươi ngày kể từ ngày ghi trên hóa đơn.</em>"
      },
      {
        "question": "The board of directors has decided to ______ the expansion of the overseas branch next fiscal year.",
        "options": {
          "A": "approve",
          "B": "approval",
          "C": "approved",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. approve</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau từ chỉ mục đích <code>to</code> (trong cấu trúc <code>decide to</code>) → cần điền một động từ nguyên mẫu (V-bare).<br>- Chọn động từ nguyên mẫu <strong class=\"hl-vocab\">approve</strong> (phê duyệt).<br><br><strong>Dịch câu:</strong><br><em>Ban giám đốc đã quyết định phê duyệt việc mở rộng chi nhánh nước ngoài vào năm tài chính tới.</em>"
      },
      {
        "question": "The company will purchase additional machinery to ______ production capacity at the main facility.",
        "options": {
          "A": "increase",
          "B": "increases",
          "C": "increased",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. increase</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau từ chỉ mục đích <code>to</code> → cần điền động từ nguyên mẫu (V-bare).<br>- Chọn động từ nguyên mẫu <strong class=\"hl-vocab\">increase</strong> (tăng lên).<br><br><strong>Dịch câu:</strong><br><em>Công ty sẽ mua thêm máy móc để tăng năng suất sản xuất tại nhà máy chính.</em>"
      },
      {
        "question": "The new policy aims to reduce operational costs ______ compromising product quality.",
        "options": {
          "A": "without",
          "B": "besides",
          "C": "except",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. without</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cần một giới từ phù hợp ngữ cảnh đi cùng danh động từ <code>compromising</code>.<br>- Ý nghĩa: giảm chi phí vận hành mà <strong>không làm ảnh hưởng/thỏa hiệp</strong> đến chất lượng sản phẩm → chọn giới từ <strong class=\"hl-vocab\">without</strong>.<br><br><strong>Dịch câu:</strong><br><em>Chính sách mới nhằm mục đích giảm chi phí vận hành mà không làm ảnh hưởng đến chất lượng sản phẩm.</em>"
      },
      {
        "question": "The research team conducted a ______ analysis of the consumer market trends before launching the product.",
        "options": {
          "A": "thorough",
          "B": "thoroughly",
          "C": "thoroughness",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. thorough</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng trước danh từ <code>analysis</code> và sau mạo từ <code>a</code> → cần điền một tính từ bổ nghĩa cho danh từ.<br>- Chọn tính từ <strong class=\"hl-vocab\">thorough</strong> (kỹ lưỡng, chi tiết, thấu đáo).<br><br><strong>Dịch câu:</strong><br><em>Nhóm nghiên cứu đã thực hiện một phân tích kỹ lưỡng về các xu hướng thị trường tiêu dùng trước khi ra mắt sản phẩm.</em>"
      },
      {
        "question": "Only employees ______ have completed the training program are authorized to operate this machinery.",
        "options": {
          "A": "who",
          "B": "whom",
          "C": "whose",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. who</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng ngay sau danh từ chỉ người <code>employees</code> và đứng trước động từ <code>have completed</code> → cần một đại từ quan hệ đóng vai trò chủ ngữ chỉ người.<br>- Chọn đại từ quan hệ <strong class=\"hl-vocab\">who</strong>.<br><br><strong>Dịch câu:</strong><br><em>Chỉ những nhân viên đã hoàn thành chương trình đào tạo mới được phép vận hành máy móc này.</em>"
      },
      {
        "question": "The supervisor requested all team members to ______ the agenda for the upcoming seminar.",
        "options": {
          "A": "review",
          "B": "reviews",
          "C": "reviewed",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. review</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau từ chỉ mục đích <code>to</code> → cần điền một động từ nguyên mẫu (V-bare).<br>- Chọn động từ nguyên mẫu <strong class=\"hl-vocab\">review</strong> (xem xét, kiểm tra).<br><br><strong>Dịch câu:</strong><br><em>Người giám sát đã yêu cầu tất cả các thành viên trong nhóm xem xét chương trình nghị sự cho buổi hội thảo sắp tới.</em>"
      },
      {
        "question": "The company's annual revenue has grown ______ over the past three years due to strong sales.",
        "options": {
          "A": "sign",
          "B": "significant",
          "C": "significantly",
        ...
        "answer": "C",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">C. significantly</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Chỗ trống đứng sau động từ ở dạng hoàn thành <code>has grown</code> → cần điền một trạng từ bổ nghĩa cho động từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">significantly</strong> (đáng kể, nhiều).<br><br><strong>Dịch câu:</strong><br><em>Doanh thu hàng năm của công ty đã tăng trưởng đáng kể trong ba năm qua nhờ doanh số bán hàng mạnh mẽ.</em>"
      }
    ]
  },
  {
    ...
    "questions": [
      {
        "question": "All employees should submit ______ vacation requests to the HR department at least two weeks in advance.",
        "options": {
          "A": "their",
          "B": "them",
          "C": "themselves",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. their</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước cụm danh từ <code>vacation requests</code> → cần tính từ sở hữu.<br>- Chọn <strong class=\"hl-vocab\">their</strong> (của họ) để chỉ các yêu cầu của nhân viên.<br><br><strong>Dịch câu:</strong><br><em>Tất cả nhân viên nên nộp các yêu cầu nghỉ phép của họ cho phòng nhân sự trước ít nhất hai tuần.</em>"
      },
      {
        "question": "The CEO will present the annual ______ reports at the shareholder meeting tomorrow.",
        "options": {
          "A": "finance",
          "B": "financial",
          "C": "financially",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. financial</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>reports</code> → cần tính từ bổ nghĩa.<br>- Chọn <strong class=\"hl-vocab\">financial</strong> (thuộc về tài chính).<br><br><strong>Dịch câu:</strong><br><em>Giám đốc điều hành sẽ trình bày các báo cáo tài chính hàng năm tại cuộc họp cổ đông vào ngày mai.</em>"
      },
      {
        "question": "Please log in to the employee portal to ______ your contact information.",
        "options": {
          "A": "update",
          "B": "updates",
          "C": "updated",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. update</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng sau <code>to</code> chỉ mục đích → cần động từ nguyên mẫu (V_bare).<br>- Chọn <strong class=\"hl-vocab\">update</strong> (cập nhật).<br><br><strong>Dịch câu:</strong><br><em>Vui lòng đăng nhập vào cổng thông tin nhân viên để cập nhật thông tin liên hệ của bạn.</em>"
      },
      {
        "question": "The shipment of raw materials was delayed ______ severe weather conditions.",
        "options": {
          "A": "because of",
          "B": "although",
          "C": "despite",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. because of</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Phía sau là cụm danh từ <code>severe weather conditions</code> (điều kiện thời tiết khắc nghiệt).<br>- Cần một giới từ chỉ nguyên nhân → chọn <strong class=\"hl-vocab\">because of</strong> (bởi vì).<br><br><strong>Dịch câu:</strong><br><em>Lô hàng nguyên liệu thô đã bị trì hoãn do điều kiện thời tiết khắc nghiệt.</em>"
      },
      {
        "question": "The committee chose Mr. Patel because he proposed the most ______ solution to the problem.",
        "options": {
          "A": "creative",
          "B": "creatively",
          "C": "create",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. creative</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>solution</code> và sau trạng từ chỉ mức độ <code>most</code> → cần tính từ.<br>- Chọn <strong class=\"hl-vocab\">creative</strong> (sáng tạo).<br><br><strong>Dịch câu:</strong><br><em>Ủy ban đã chọn ông Patel vì ông đã đề xuất giải pháp sáng tạo nhất cho vấn đề.</em>"
      },
      {
        "question": "Staff members are required to attend the seminar ______ they are working remotely.",
        "options": {
          "A": "even if",
          "B": "despite",
          "C": "besides",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. even if</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Phía sau là một mệnh đề hoàn chỉnh (S + V) → cần một liên từ.<br>- Phù hợp ngữ cảnh chỉ sự nhượng bộ → chọn liên từ <strong class=\"hl-vocab\">even if</strong> (ngay cả khi).<br><br><strong>Dịch câu:</strong><br><em>Các nhân viên được yêu cầu tham dự buổi hội thảo ngay cả khi họ đang làm việc từ xa.</em>"
      },
      {
        "question": "The new security system will be ______ installed throughout the building next weekend.",
        "options": {
          "A": "complete",
          "B": "completely",
          "C": "completeness",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. completely</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng giữa trợ động từ bị động <code>will be</code> và động từ phân từ hai <code>installed</code> → cần một trạng từ bổ nghĩa.<br>- Chọn trạng từ <strong class=\"hl-vocab\">completely</strong> (hoàn toàn).<br><br><strong>Dịch câu:</strong><br><em>Hệ thống an ninh mới sẽ được lắp đặt hoàn toàn trong toàn bộ tòa nhà vào cuối tuần tới.</em>"
      },
      {
        "question": "The marketing director is pleased with the ______ results of the advertising campaign.",
        "options": {
          "A": "initial",
          "B": "initially",
          "C": "initiation",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. initial</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>results</code> → cần tính từ bổ nghĩa.<br>- Chọn <strong class=\"hl-vocab\">initial</strong> (ban đầu).<br><br><strong>Dịch câu:</strong><br><em>Giám đốc tiếp thị hài lòng với kết quả ban đầu của chiến dịch quảng cáo.</em>"
      },
      {
        "question": "Mr. Wong is responsible for ______ the hiring process for new software engineers.",
        "options": {
          "A": "manage",
          "B": "managing",
          "C": "management",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. managing</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Sau giới từ <code>for</code> và có tân ngữ phía sau (the hiring process) → cần danh động từ (V-ing).<br>- Chọn <strong class=\"hl-vocab\">managing</strong> (việc quản lý).<br><br><strong>Dịch câu:</strong><br><em>Ông Wong chịu trách nhiệm quản lý quy trình tuyển dụng kỹ sư phần mềm mới.</em>"
      },
      {
        "question": "The new guidelines are designed to help employees work more ______.",
        "options": {
          "A": "efficient",
          "B": "efficiently",
          "C": "efficiency",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. efficiently</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Bổ nghĩa cho động từ thường <code>work</code> → cần một trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">efficiently</strong> (một cách hiệu quả).<br><br><strong>Dịch câu:</strong><br><em>Các hướng dẫn mới được thiết kế để giúp nhân viên làm việc hiệu quả hơn.</em>"
      },
      {
        "question": "The technical committee has ______ completed the safety inspection of the manufacturing plant.",
        "options": {
          "A": "successful",
          "B": "successfully",
          "C": "success",
        ...
        "answer": "B",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">B. successfully</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng giữa trợ động từ <code>has</code> và phân từ hai <code>completed</code> → cần trạng từ.<br>- Chọn <strong class=\"hl-vocab\">successfully</strong> (một cách thành công/tốt đẹp).<br><br><strong>Dịch câu:</strong><br><em>Ủy ban kỹ thuật đã hoàn thành tốt đẹp việc kiểm tra an toàn của nhà máy sản xuất.</em>"
      },
      {
        "question": "Ms. Jenkins will present her research findings ______ the upcoming scientific symposium.",
        "options": {
          "A": "at",
          "B": "on",
          "C": "to",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. at</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Giới từ đi kèm với các sự kiện, hội nghị, hội thảo → dùng giới từ <strong class=\"hl-vocab\">at</strong> (tại).<br>- Chọn giới từ <strong class=\"hl-vocab\">at</strong>.<br><br><strong>Dịch câu:</strong><br><em>Cô Jenkins sẽ trình bày các kết quả nghiên cứu của mình tại hội nghị khoa học sắp tới.</em>"
      },
      {
        "question": "Customer feedback is extremely valuable ______ it helps us improve our product quality.",
        "options": {
          "A": "because",
          "B": "due to",
          "C": "although",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. because</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Sau chỗ trống là một mệnh đề hoàn chỉnh (S + V) chỉ lý do nguyên nhân → cần liên từ phụ thuộc chỉ nguyên nhân.<br>- Chọn <strong class=\"hl-vocab\">because</strong> (bởi vì). Do <code>due to</code> là giới từ nên không đi với mệnh đề.<br><br><strong>Dịch câu:</strong><br><em>Ý kiến phản hồi của khách hàng là vô cùng quý giá vì nó giúp chúng tôi cải thiện chất lượng sản phẩm.</em>"
      },
      {
        "question": "The board members discussed the merger ______ for nearly three hours before voting.",
        "options": {
          "A": "proposal",
          "B": "propose",
          "C": "proposing",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. proposal</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng sau danh từ <code>merger</code> để tạo thành cụm danh từ kép: <code>merger proposal</code> (đề xuất sáp nhập).<br>- Chọn danh từ <strong class=\"hl-vocab\">proposal</strong>.<br><br><strong>Dịch câu:</strong><br><em>Các thành viên ban quản trị đã thảo luận về đề xuất sáp nhập trong gần ba giờ trước khi bỏ phiếu.</em>"
      },
      {
        "question": "The newly hired manager has ______ experience in corporate restructuring.",
        "options": {
          "A": "extensive",
          "B": "extend",
          "C": "extensively",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. extensive</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>experience</code> → cần tính từ bổ nghĩa.<br>- Chọn <strong class=\"hl-vocab\">extensive</strong> (sâu rộng, phong phú).<br><br><strong>Dịch câu:</strong><br><em>Quản lý mới được thuê có kinh nghiệm sâu rộng trong việc tái cấu trúc doanh nghiệp.</em>"
      },
      {
        "question": "Employees who wish to enroll in the training course must do so ______ Friday afternoon.",
        "options": {
          "A": "by",
          "B": "until",
          "C": "since",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. by</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cần giới từ chỉ thời hạn chót (deadline) → chọn <strong class=\"hl-vocab\">by</strong> (trước/hạn chót là).<br>- Tránh nhầm với <code>until</code> chỉ hành động kéo dài liên tục cho tới thời điểm đó.<br><br><strong>Dịch câu:</strong><br><em>Những nhân viên muốn đăng ký khóa đào tạo phải đăng ký trước chiều thứ Sáu.</em>"
      },
      {
        "question": "The company decided to implement the new policy ______ opposition from some staff members.",
        "options": {
          "A": "despite",
          "B": "although",
          "C": "because of",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. despite</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Sau chỗ trống là cụm danh từ chỉ sự đối lập → cần giới từ chỉ sự nhượng bộ.<br>- Chọn giới từ <strong class=\"hl-vocab\">despite</strong> (mặc dù). Loại <code>although</code> vì là liên từ (đòi hỏi mệnh đề).<br><br><strong>Dịch câu:</strong><br><em>Công ty quyết định thực hiện chính sách mới bất chấp sự phản đối từ một số nhân viên.</em>"
      },
      {
        "question": "All personal data must be kept strictly ______ to protect customer privacy.",
        "options": {
          "A": "confidential",
          "B": "confidentiality",
          "C": "confidentially",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. confidential</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cấu trúc bị động: <code>keep + object + adjective</code> → dạng bị động là <code>be kept + adjective</code>.<br>- Trạng từ <code>strictly</code> bổ nghĩa cho tính từ phía sau. Chọn tính từ <strong class=\"hl-vocab\">confidential</strong> (bảo mật/kín).<br><br><strong>Dịch câu:</strong><br><em>Tất cả dữ liệu cá nhân phải được giữ tuyệt đối bảo mật để bảo vệ quyền riêng tư của khách hàng.</em>"
      },
      {
        "question": "The supervisor requested that all team members ______ the project guidelines before the launch.",
        "options": {
          "A": "review",
          "B": "reviews",
          "C": "reviewed",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. review</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cấu trúc câu giả định (Subjunctive mood) đi với động từ chỉ yêu cầu, đề nghị: <code>request + that + S + V (nguyên mẫu không chia / bare infinitive)</code>.<br>- Chọn động từ nguyên mẫu <strong class=\"hl-vocab\">review</strong>.<br><br><strong>Dịch câu:</strong><br><em>Người giám sát đã yêu cầu tất cả các thành viên trong nhóm xem xét các hướng dẫn của dự án trước khi khởi chạy.</em>"
      },
      {
        "question": "Please inform the IT helpdesk immediately ______ you experience any system issues.",
        "options": {
          "A": "if",
          "B": "whether",
          "C": "unless",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. if</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Mối quan hệ điều kiện giữa hai mệnh đề (nếu gặp sự cố hệ thống thì báo ngay) → chọn liên từ chỉ điều kiện <strong class=\"hl-vocab\">if</strong> (nếu).<br><br><strong>Dịch câu:</strong><br><em>Vui lòng thông báo ngay cho bộ phận hỗ trợ CNTT nếu bạn gặp bất kỳ sự cố hệ thống nào.</em>"
      },
      {
        "question": "The renovation of the branch office is expected to be completed ______ schedule.",
        "options": {
          "A": "ahead of",
          "B": "at",
          "C": "for",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. ahead of</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cụm giới từ chỉ thời gian cố định: <code>ahead of schedule</code> (trước tiến độ/lịch trình).<br>- Chọn giới từ <strong class=\"hl-vocab\">ahead of</strong>.<br><br><strong>Dịch câu:</strong><br><em>Việc cải tạo văn phòng chi nhánh dự kiến sẽ hoàn thành trước tiến độ.</em>"
      },
      {
        "question": "We must ensure that all machinery is maintained in ______ working condition.",
        "options": {
          "A": "excellent",
          "B": "excellently",
          "C": "excel",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. excellent</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước cụm danh từ <code>working condition</code> → cần một tính từ bổ nghĩa.<br>- Chọn tính từ <strong class=\"hl-vocab\">excellent</strong> (xuất sắc, tốt).<br><br><strong>Dịch câu:</strong><br><em>Chúng ta phải đảm bảo rằng tất cả máy móc đều được bảo dưỡng ở điều kiện hoạt động tốt.</em>"
      },
      {
        "question": "The guest speaker spoke so ______ that the entire audience remained fully engaged.",
        "options": {
          "A": "eloquently",
          "B": "eloquent",
          "C": "eloquence",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. eloquently</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng sau cấu trúc <code>so... that</code> và bổ nghĩa cho động từ thường <code>spoke</code> → cần trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">eloquently</strong> (hùng hồn, lưu loát).<br><br><strong>Dịch câu:</strong><br><em>Diễn giả khách mời đã phát biểu hùng hồn đến nỗi toàn bộ khán giả đều tập trung lắng nghe.</em>"
      },
      {
        "question": "The new software allows users to generate custom financial reports ______.",
        "options": {
          "A": "easily",
          "B": "easy",
          "C": "ease",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. easily</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng ở cuối câu và bổ nghĩa cho động từ <code>generate</code> → cần trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">easily</strong> (một cách dễ dàng).<br><br><strong>Dịch câu:</strong><br><em>Phần mềm mới cho phép người dùng tạo các báo cáo tài chính tùy chỉnh một cách dễ dàng.</em>"
      },
      {
        "question": "Mr. Davis will serve as the interim manager ______ a permanent replacement is found.",
        "options": {
          "A": "until",
          "B": "by",
          "C": "during",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. until</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Sau chỗ trống là một mệnh đề chỉ thời gian kéo dài cho đến khi một sự kiện khác xảy ra → chọn liên từ <strong class=\"hl-vocab\">until</strong> (cho đến khi).<br><br><strong>Dịch câu:</strong><br><em>Ông Davis sẽ đảm nhiệm vai trò quản lý tạm thời cho đến khi tìm được người thay thế chính thức.</em>"
      },
      {
        "question": "The laboratory technicians must handle all chemicals ______ to prevent accidents.",
        "options": {
          "A": "cautiously",
          "B": "cautious",
          "C": "caution",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. cautiously</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Bổ nghĩa cho động từ thường <code>handle</code> → cần trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">cautiously</strong> (một cách cẩn trọng).<br><br><strong>Dịch câu:</strong><br><em>Các kỹ thuật viên phòng thí nghiệm phải xử lý tất cả các hóa chất một cách cẩn trọng để ngăn ngừa tai nạn.</em>"
      },
      {
        "question": "Any suggestions for reducing office waste should be submitted ______ the sustainability committee.",
        "options": {
          "A": "to",
          "B": "for",
          "C": "by",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. to</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cấu trúc động từ: <code>submit something to someone / some committee</code> (nộp/gửi cái gì đến ai đó / ủy ban nào đó).<br>- Chọn giới từ <strong class=\"hl-vocab\">to</strong>.<br><br><strong>Dịch câu:</strong><br><em>Bất kỳ đề xuất nào về việc giảm thiểu chất thải văn phòng nên được gửi lên ủy ban phát triển bền vững.</em>"
      },
      {
        "question": "The corporate event was postponed ______ the unexpected train strike.",
        "options": {
          "A": "due to",
          "B": "because",
          "C": "although",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. due to</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước cụm danh từ chỉ lý do nguyên nhân (unexpected train strike) → cần giới từ chỉ nguyên nhân.<br>- Chọn <strong class=\"hl-vocab\">due to</strong> (do/vì). Loại <code>because</code> vì là liên từ.<br><br><strong>Dịch câu:</strong><br><em>Sự kiện của công ty đã bị hoãn lại do cuộc đình công xe lửa bất ngờ.</em>"
      },
      {
        "question": "The HR director praised the team for their ______ contribution to the project.",
        "options": {
          "A": "valuable",
          "B": "value",
          "C": "valuably",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. valuable</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>contribution</code> và sau tính từ sở hữu <code>their</code> → cần một tính từ bổ nghĩa.<br>- Chọn tính từ <strong class=\"hl-vocab\">valuable</strong> (có giá trị).<br><br><strong>Dịch câu:</strong><br><em>Giám đốc nhân sự đã ca ngợi cả nhóm vì sự đóng góp có giá trị của họ cho dự án.</em>"
      },
      {
        "question": "The CEO expressed her ______ gratitude to all staff members for their hard work.",
        "options": {
          "A": "sincere",
          "B": "sincerely",
          "C": "sincerity",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. sincere</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>gratitude</code> và sau tính từ sở hữu <code>her</code> → cần một tính từ bổ nghĩa.<br>- Chọn tính từ <strong class=\"hl-vocab\">sincere</strong> (chân thành).<br><br><strong>Dịch câu:</strong><br><em>Giám đốc điều hành đã bày tỏ lòng biết ơn chân thành của mình tới tất cả các nhân viên vì sự làm việc chăm chỉ của họ.</em>"
      }
    ]
  },
  {
    ...
    "questions": [
      {
        "question": "The marketing team is developing a new campaign to promote ______ latest product line.",
        "options": {
          "A": "our",
          "B": "we",
          "C": "us",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. our</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước cụm danh từ <code>latest product line</code> → cần tính từ sở hữu.<br>- Chọn <strong class=\"hl-vocab\">our</strong> (của chúng tôi).<br><br><strong>Dịch câu:</strong><br><em>Nhóm tiếp thị đang phát triển một chiến dịch mới để quảng bá dòng sản phẩm mới nhất của chúng tôi.</em>"
      },
      {
        "question": "Please submit your travel expense reports directly to the accounts ______ for reimbursement.",
        "options": {
          "A": "department",
          "B": "depart",
          "C": "departed",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. department</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng sau danh từ <code>accounts</code> để tạo thành cụm danh từ: <code>accounts department</code> (phòng kế toán).<br>- Chọn danh từ <strong class=\"hl-vocab\">department</strong>.<br><br><strong>Dịch câu:</strong><br><em>Vui lòng nộp báo cáo chi phí đi lại của bạn trực tiếp cho phòng kế toán để được hoàn tiền.</em>"
      },
      {
        "question": "The manager was pleased with the ______ completion of the warehouse inventory audit.",
        "options": {
          "A": "timely",
          "B": "time",
          "C": "timeliness",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. timely</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>completion</code> và sau mạo từ <code>the</code> → cần tính từ bổ nghĩa.<br>- Chọn tính từ đuôi -ly đặc biệt <strong class=\"hl-vocab\">timely</strong> (kịp thời, đúng lúc).<br><br><strong>Dịch câu:</strong><br><em>Quản lý hài lòng với việc hoàn thành kịp thời việc kiểm kê kho hàng.</em>"
      },
      {
        "question": "The new software was designed to run ______ on all major operating systems.",
        "options": {
          "A": "efficiently",
          "B": "efficient",
          "C": "efficiency",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. efficiently</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Bổ nghĩa cho động từ thường <code>run</code> → cần trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">efficiently</strong> (một cách hiệu quả).<br><br><strong>Dịch câu:</strong><br><em>Phần mềm mới được thiết kế để chạy hiệu quả trên tất cả các hệ điều hành lớn.</em>"
      },
      {
        "question": "The conference had to be canceled ______ the sudden flight delays.",
        "options": {
          "A": "due to",
          "B": "because",
          "C": "although",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. due to</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước cụm danh từ <code>the sudden flight delays</code> để chỉ nguyên nhân → chọn giới từ <strong class=\"hl-vocab\">due to</strong> (do/vì).<br><br><strong>Dịch câu:</strong><br><em>Hội nghị đã phải hủy bỏ do chuyến bay bị hoãn đột ngột.</em>"
      },
      {
        "question": "Mr. Patel will lead the negotiation ______ Ms. Garcia is attending a training seminar.",
        "options": {
          "A": "while",
          "B": "during",
          "C": "because of",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. while</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Liên kết hai mệnh đề xảy ra song song → chọn liên từ <strong class=\"hl-vocab\">while</strong> (trong khi). <code>during</code> là giới từ nên không đi với mệnh đề.<br><br><strong>Dịch câu:</strong><br><em>Ông Patel sẽ dẫn dắt cuộc đàm phán trong khi bà Garcia tham dự hội thảo đào tạo.</em>"
      },
      {
        "question": "The legal advisor recommends that the client ______ the contract carefully before signing.",
        "options": {
          "A": "review",
          "B": "reviews",
          "C": "reviewed",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. review</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cấu trúc câu giả định đi sau động từ khuyên bảo: <code>recommend + that + S + V (nguyên mẫu không chia)</code>.<br>- Chọn động từ nguyên mẫu <strong class=\"hl-vocab\">review</strong>.<br><br><strong>Dịch câu:</strong><br><em>Cố vấn pháp lý khuyên khách hàng nên xem xét kỹ hợp đồng trước khi ký.</em>"
      },
      {
        "question": "All visitors must obtain a security badge ______ entering the research facility.",
        "options": {
          "A": "before",
          "B": "during",
          "C": "between",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. before</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Sau chỗ trống là danh động từ <code>entering</code> chỉ hành động chuẩn bị thực hiện → chọn giới từ thời gian <strong class=\"hl-vocab\">before</strong> (trước khi).<br><br><strong>Dịch câu:</strong><br><em>Tất cả khách truy cập phải nhận thẻ an ninh trước khi vào cơ sở nghiên cứu.</em>"
      },
      {
        "question": "The HR director announced that Ms. Kim will be responsible ______ the training program.",
        "options": {
          "A": "for",
          "B": "to",
          "C": "with",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. for</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cấu trúc tính từ đi với giới từ: <code>be responsible for something / doing something</code> (chịu trách nhiệm cho cái gì / việc gì).<br>- Chọn giới từ <strong class=\"hl-vocab\">for</strong>.<br><br><strong>Dịch câu:</strong><br><em>Giám đốc nhân sự thông báo rằng cô Kim sẽ chịu trách nhiệm về chương trình đào tạo.</em>"
      },
      {
        "question": "The company has seen a ______ increase in online sales over the last quarter.",
        "options": {
          "A": "significant",
          "B": "significance",
          "C": "significantly",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. significant</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>increase</code> và sau mạo từ <code>a</code> → cần tính từ bổ nghĩa.<br>- Chọn tính từ <strong class=\"hl-vocab\">significant</strong> (đáng kể).<br><br><strong>Dịch câu:</strong><br><em>Công ty đã thấy doanh số bán hàng trực tuyến tăng đáng kể trong quý vừa qua.</em>"
      },
      {
        "question": "Applicants must provide at least two professional ______ along with their résumés.",
        "options": {
          "A": "references",
          "B": "refers",
          "C": "referred",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. references</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng sau tính từ <code>professional</code> và đứng ở vị trí tân ngữ → cần danh từ số nhiều (do có lượng từ <code>at least two</code>).<br>- Chọn danh từ <strong class=\"hl-vocab\">references</strong> (người/thư tham chiếu, chứng nhận).<br><br><strong>Dịch câu:</strong><br><em>Ứng viên phải cung cấp ít nhất hai người tham chiếu chuyên môn cùng với sơ yếu lý lịch của họ.</em>"
      },
      {
        "question": "The technician is inspecting the air conditioning units to ensure they operate ______.",
        "options": {
          "A": "properly",
          "B": "proper",
          "C": "propriety",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. properly</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Bổ nghĩa cho động từ thường <code>operate</code> → cần trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">properly</strong> (một cách chính xác/hoạt động tốt).<br><br><strong>Dịch câu:</strong><br><em>Kỹ thuật viên đang kiểm tra các thiết bị điều hòa để đảm bảo chúng hoạt động tốt.</em>"
      },
      {
        "question": "The new policy will become ______ starting next Monday morning.",
        "options": {
          "A": "effective",
          "B": "effect",
          "C": "effectively",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. effective</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cấu trúc động từ liên kết: <code>become + adjective</code> (trở nên như thế nào).<br>- Cụm từ cố định: <code>become effective</code> (có hiệu lực). Chọn tính từ <strong class=\"hl-vocab\">effective</strong>.<br><br><strong>Dịch câu:</strong><br><em>Chính sách mới sẽ bắt đầu có hiệu lực từ sáng thứ Hai tuần tới.</em>"
      },
      {
        "question": "The supervisor congratulated the design team ______ their outstanding performance.",
        "options": {
          "A": "on",
          "B": "for",
          "C": "with",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. on</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cấu trúc động từ đi kèm giới từ: <code>congratulate someone on something</code> (chúc mừng ai đó về điều gì).<br>- Chọn giới từ <strong class=\"hl-vocab\">on</strong>.<br><br><strong>Dịch câu:</strong><br><em>Người giám sát chúc mừng nhóm thiết kế về thành tích xuất sắc của họ.</em>"
      },
      {
        "question": "The main facility is expected to reopen ______ the end of the month.",
        "options": {
          "A": "by",
          "B": "until",
          "C": "since",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. by</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cần giới từ chỉ mốc thời gian hoàn thành hành động (trước thời điểm đó) → chọn giới từ <strong class=\"hl-vocab\">by</strong> (trước/hạn chót là).<br><br><strong>Dịch câu:</strong><br><em>Cơ sở chính dự kiến sẽ mở cửa trở lại trước cuối tháng.</em>"
      },
      {
        "question": "We apologized for the inconvenience caused by the ______ of the conference.",
        "options": {
          "A": "cancellation",
          "B": "cancel",
          "C": "canceling",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. cancellation</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng sau mạo từ <code>the</code> và trước giới từ <code>of</code> → cần danh từ.<br>- Chọn danh từ <strong class=\"hl-vocab\">cancellation</strong> (sự hủy bỏ).<br><br><strong>Dịch câu:</strong><br><em>Chúng tôi xin lỗi vì sự bất tiện gây ra bởi sự hủy bỏ hội nghị.</em>"
      },
      {
        "question": "The director wants to hire a consultant who has ______ knowledge of tax laws.",
        "options": {
          "A": "extensive",
          "B": "extend",
          "C": "extensively",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. extensive</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>knowledge</code> và sau mạo từ <code>a</code> → cần tính từ bổ nghĩa.<br>- Chọn tính từ <strong class=\"hl-vocab\">extensive</strong> (rộng lớn, sâu sắc).<br><br><strong>Dịch câu:</strong><br><em>Giám đốc muốn thuê một cố vấn có kiến thức sâu rộng về luật thuế.</em>"
      },
      {
        "question": "The billing statement must be paid in full within thirty days of the ______ date.",
        "options": {
          "A": "invoice",
          "B": "invoices",
          "C": "invoiced",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. invoice</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng trước danh từ <code>date</code> tạo thành cụm danh từ kép thông dụng: <code>invoice date</code> (ngày xuất hóa đơn).<br>- Chọn danh từ <strong class=\"hl-vocab\">invoice</strong>.<br><br><strong>Dịch câu:</strong><br><em>Sao kê thanh toán phải được trả đầy đủ trong vòng 30 ngày kể từ ngày xuất hóa đơn.</em>"
      },
      {
        "question": "The project was completed ahead of schedule ______ the dedication of the team.",
        "options": {
          "A": "thanks to",
          "B": "because",
          "C": "although",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. thanks to</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Phía sau là một cụm danh từ mang nghĩa tích cực chỉ nguyên nhân mang lại thành công → chọn giới từ <strong class=\"hl-vocab\">thanks to</strong> (nhờ có).<br><br><strong>Dịch câu:</strong><br><em>Dự án đã được hoàn thành trước thời hạn nhờ sự cống hiến của cả đội.</em>"
      },
      {
        "question": "Please ensure that all light fixtures are switched ______ before leaving the office.",
        "options": {
          "A": "off",
          "B": "out",
          "C": "down",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. off</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cụm động từ chỉ tắt thiết bị điện: <code>switch off / turn off</code> (tắt điện/tắt đèn).<br>- Chọn giới từ <strong class=\"hl-vocab\">off</strong>.<br><br><strong>Dịch câu:</strong><br><em>Vui lòng đảm bảo rằng tất cả các thiết bị chiếu sáng đã được tắt trước khi rời văn phòng.</em>"
      },
      {
        "question": "The new software is fully ______ with all older versions of the operating system.",
        "options": {
          "A": "compatible",
          "B": "compatibly",
          "C": "compatibility",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. compatible</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Đứng sau động từ liên kết <code>is</code> và bổ nghĩa bởi trạng từ <code>fully</code> → cần tính từ.<br>- Cấu trúc: <code>be compatible with something</code> (tương thích với cái gì). Chọn tính từ <strong class=\"hl-vocab\">compatible</strong>.<br><br><strong>Dịch câu:</strong><br><em>Phần mềm mới hoàn toàn tương thích với tất cả các phiên bản cũ hơn của hệ điều hành.</em>"
      },
      {
        "question": "The customer service representatives are trained to handle complaints ______.",
        "options": {
          "A": "professionally",
          "B": "professional",
          "C": "professionalism",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. professionally</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Bổ nghĩa cho động từ thường <code>handle</code> ở cuối câu → cần trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">professionally</strong> (một cách chuyên nghiệp).<br><br><strong>Dịch câu:</strong><br><em>Các đại diện dịch vụ khách hàng được đào tạo để giải quyết các khiếu nại một cách chuyên nghiệp.</em>"
      },
      {
        "question": "The manager requested that the team ______ the monthly budget reports immediately.",
        "options": {
          "A": "submit",
          "B": "submits",
          "C": "submitted",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. submit</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cấu trúc câu giả định đi sau động từ yêu cầu: <code>request + that + S + V (nguyên mẫu không chia)</code>.<br>- Chọn động từ nguyên mẫu <strong class=\"hl-vocab\">submit</strong>.<br><br><strong>Dịch câu:</strong><br><em>Quản lý yêu cầu nhóm nộp báo cáo ngân sách hàng tháng ngay lập tức.</em>"
      },
      {
        "question": "The board members approved the proposal ______ it aligns with the long-term goals.",
        "options": {
          "A": "since",
          "B": "due to",
          "C": "despite",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. since</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Phía sau là một mệnh đề chỉ lý do → chọn liên từ chỉ lý do <strong class=\"hl-vocab\">since</strong> (bởi vì).<br><br><strong>Dịch câu:</strong><br><em>Các thành viên hội đồng quản trị đã thông qua đề xuất vì nó phù hợp với các mục tiêu dài hạn.</em>"
      },
      {
        "question": "Mr. Chang was appointed as the head of the marketing department ______ his success.",
        "options": {
          "A": "because of",
          "B": "although",
          "C": "because",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. because of</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Phía sau là cụm danh từ chỉ lý do nguyên nhân (his success) → chọn giới từ chỉ lý do <strong class=\"hl-vocab\">because of</strong> (do/vì).<br><br><strong>Dịch câu:</strong><br><em>Ông Chang được bổ nhiệm làm trưởng phòng tiếp thị vì sự thành công của ông.</em>"
      },
      {
        "question": "We must inspect all incoming shipments ______ for potential damage.",
        "options": {
          "A": "thoroughly",
          "B": "thorough",
          "C": "thoroughness",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. thoroughly</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Bổ nghĩa cho động từ thường <code>inspect</code> → cần trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">thoroughly</strong> (một cách cẩn thận/kỹ lưỡng).<br><br><strong>Dịch câu:</strong><br><em>Chúng ta phải kiểm tra kỹ lưỡng tất cả các lô hàng sắp tới để phát hiện các hư hỏng tiềm ẩn.</em>"
      },
      {
        "question": "Only employees ______ have completed the safety course are allowed to enter the laboratory.",
        "options": {
          "A": "who",
          "B": "whom",
          "C": "whose",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. who</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cần đại từ quan hệ thay thế cho danh từ chỉ người <code>employees</code> và đóng vai trò làm chủ ngữ cho động từ <code>have completed</code> phía sau → chọn <strong class=\"hl-vocab\">who</strong>.<br><br><strong>Dịch câu:</strong><br><em>Chỉ những nhân viên đã hoàn thành khóa học an toàn mới được phép vào phòng thí nghiệm.</em>"
      },
      {
        "question": "The construction workers completed the project ______ schedule despite the rain.",
        "options": {
          "A": "on",
          "B": "at",
          "C": "to",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. on</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Cụm giới từ chỉ thời gian: <code>on schedule</code> (đúng lịch trình/tiến độ).<br>- Chọn giới từ <strong class=\"hl-vocab\">on</strong>.<br><br><strong>Dịch câu:</strong><br><em>Các công nhân xây dựng đã hoàn thành dự án đúng tiến độ bất chấp mưa.</em>"
      },
      {
        "question": "The company will launch a new line of organic cosmetics ______ next spring.",
        "options": {
          "A": "sometime",
          "B": "sometimes",
          "C": "somewhat",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. sometime</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Trạng từ chỉ một thời điểm không xác định trong tương lai → chọn <strong class=\"hl-vocab\">sometime</strong> (vào một lúc nào đó). Tránh nhầm với <code>sometimes</code> (thỉnh thoảng).<br><br><strong>Dịch câu:</strong><br><em>Công ty sẽ ra mắt một dòng mỹ phẩm hữu cơ mới vào một thời điểm nào đó trong mùa xuân tới.</em>"
      },
      {
        "question": "The customer service team is committed to resolving issues ______ for all clients.",
        "options": {
          "A": "promptly",
          "B": "prompt",
          "C": "promptness",
        ...
        "answer": "A",
        "explanation": "<strong>Đáp án đúng: <span class=\"hl-green\">A. promptly</span></strong><br><br><strong>Giải thích chi tiết:</strong><br>- Bổ nghĩa cho động từ dạng V-ing <code>resolving</code> → cần trạng từ.<br>- Chọn trạng từ <strong class=\"hl-vocab\">promptly</strong> (một cách nhanh chóng, kịp thời).<br><br><strong>Dịch câu:</strong><br><em>Đội ngũ dịch vụ khách hàng cam kết giải quyết các vấn đề một cách nhanh chóng cho tất cả các khách hàng.</em>"
      }
    ]
  },
  {
